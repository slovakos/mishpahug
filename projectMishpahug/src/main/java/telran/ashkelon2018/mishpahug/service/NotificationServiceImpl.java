...
public class NotificationServiceImpl implements NotificationService {
	...
	@Override
	public List<Notification> getNotificationsList(String email) {
//		UserNotifications user = notificationRepository.findById(email).orElse(null);// TODO check user? sort?
//		if (user == null) {
